...
-- CreateEnum
CREATE TYPE "RentalStatus" AS ENUM ('PENDING', 'CONFIRMED', 'PICKED_UP', 'RETURNED', 'COMPLETED', 'CANCELLED');
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_rentalOrderItemId_fkey" FOREIGN KEY ("rentalOrderItemId") REFERENCES "rental_order_items"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
